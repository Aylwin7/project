...
class Messages extends Component {
  ...
  scheduleLocalNotification() {
    FCM.scheduleLocalNotification({
      id: "testnotif",
      _userText: "schedule Local Notification",
  ...
  showLocalNotificationWithAction() {
    FCM.presentLocalNotification({
      ...
      _userText: "Local Notification With Action",
  ...
  render() {
    ...
    return (
      <View >
          <Head col={this.props.primaryColor}  title={'Fcm App'} iconleft={'menu'} iconright={'settings'} fun={(navigation)=>{this.props.navigation.navigate('DrawerOpen')}}
